package NamingPackagesStaticFinal.PackageChallenge;

import NamingPackagesStaticFinal.PackageChallenge.Series.Series;
...
public class Main {
    ...
    //in ym case java-basics library will be used as the project is all together
