package InnerAbstractClassesInterfaces.Interfaces.LinkedListPlaylistChallenge;
//Changed linked list to array list because java implements interfaces heavily
import java.util.*;
